...
bcftools reheader --samples meta/thalassinus-names.tsv outputs/105/plink.vcf.gz | bcftools +fill-tags -- -t MAF | bcftools view -q 0.01:minor |  bcftools +prune -m 0.2 -w 10000bp -n 1 -N maxAF > outputs/105/pruned-farm.vcf

```

1078 variable sites accoding to iqtree

```{r}
t<-read.tree("outputs/105/100-01.min4.phy.varsites.phy.contree")
u<-midpoint_root(t)
ggtree(u) +
  geom_tiplab()
```
