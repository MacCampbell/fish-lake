...
mt %>% select(SampleName) %>% write_tsv("meta/thalassinus-names.tsv", col_names = FALSE)
```
...
#prune (local)
bcftools  view -S outputs/105/100.names outputs/107/plink.vcf.gz | bcftools +fill-tags | bcftools view -q 0.01:minor | bcftools +prune -m 0.20 -w 10000 > outputs/107/438-01.vcf
