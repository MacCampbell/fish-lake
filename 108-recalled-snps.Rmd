...
bcftools reheader --samples meta/544.names outputs/108/plink.vcf.gz | bcftools +fill-tags -- -t MAF | bcftools view -q 0.01:minor | bcftools +prune -m 0.2 -w 10000bp -n 1 -N random > outputs/108/pruned.vcf
```
