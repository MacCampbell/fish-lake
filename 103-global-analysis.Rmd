...
```{sh, eval=FALSE}
srun -p bigmemhigh -t 36:00:00 --mem=128G --nodes=1 $HOME/angsd/angsd -P 12  \
...
-out outputs/103/test1124-ibs-90 >outputs/103/test1124-ibs-90.out 2> outputs/104/test1124-ibs-90.err &
```
